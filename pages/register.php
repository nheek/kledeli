...
<head>
    ...
    <title>Register - Kledeli</title>
</head>

<body>
    <div class="login-cont">
        <h1 class="logo">
            <a href="/">KLEDELI </a> <span class="logo-right">Register</span>
        </h1>
        <div class="login-input-cont">
            <div class="login-input-divider">
                <input type="text" class="login-input" placeholder="Fornavn">
                <input type="password" class="login-input" placeholder="Etternavn">
        ...
        <div class="nav-bottom">
            <a href="#">Back to homepage</a> <a id="register-button" href="#">Login</a>
        </div>
    </div>
</body>
